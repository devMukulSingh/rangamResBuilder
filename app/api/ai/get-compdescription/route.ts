...
export async function GET(req: NextRequest, res: NextResponse) {
    ...
    try{
        ...
        if (!competence) return NextResponse.json({ error: 'competence is required' }, { status: 400 });
        ...
        return NextResponse.json({ error: `Error in GET competence Description REQ ${e}` },{status:500})
    }
