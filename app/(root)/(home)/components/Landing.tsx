    ...
    <div className="w-full px-5 sm:px-10 lg:px-20 flex flex-col justify-center gap-5 sm:gap-20 py-10 md:flex-row">
      <div className="flex flex-col gap-5 md:w-2/3 w-full">
        ...
        <h1 className="text-lg sm:text-xl mt-5">
          Experience how our AI technology can swiftly evaluate your background
          and generate a professional resume in just 10 minutes. Your resume is
          crucial - make it stand out.
        </h1>
